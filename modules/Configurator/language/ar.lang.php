...
$mod_strings = array(
    ...
    'LBL_SNOOZE_TIMER' => 'تعيين غفوة للإشعارات',
    ...
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'سيتم استخدام إعداد LDAP هذا فقط لمصادقة API v4. لإعداد تسجيل الدخول إلى النظام لاستخدام LDAP، أضف التكوينات المطلوبة إلى الملف .env.local file. راجع تعليمات إعداد LDAP للمزيد من المعلومات.',
    ...
    'LBL_SET_SUBPANEL_PAGINATION_TYPE' => 'نوع الترقيم للصفحات الفرعية',
    'LBL_SET_LISTVIEW_PAGINATION_TYPE' => 'نوع الترقيم للصفحات في عرض القوائم',
    'LBL_LIST_ENTRIES_PER_MODAL' => 'قائمة السجلات المنبثقة',
    'LBL_SET_RECORD_MODAL_PAGINATION_TYPE' => 'نوع ترقيم صفحات قائمة السجلات المنبثقة',
